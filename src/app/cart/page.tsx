    ...
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
        {steps.map((step) => (
          ...
          >
            <div
              className={`w-6 h-6 rounded-full text-white dark:text-black p-4 flex items-center justify-center ${
                step.id === activeStep ? "bg-black dark:bg-white" : "bg-neutral-400"
              }`}
            >
              {step.id}
            </div>
      ...
      <div className="w-full flex flex-col lg:flex-row gap-16">
                ...
                <div className="flex gap-8">
                  ...
                  <div className="flex flex-col justify-between">
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-xs text-neutral-500">Color: {item.selectedColor}</p>
                    </div>
        ...
        {/* DETAILS */}
        <div className="w-full lg:w-5/12 shadow-lg border-1 bg-white dark:bg-black  p-8 rounded-lg flex flex-col gap-8 h-max">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-between text-sm">
              <p className="text-neutral-500">Discount(10%)</p>
